        ...
        <div class="grid-view">
            <div class="toolbar">
                <div class="tab-button">
                    <button v-for="tab in tabs" :key="tab" @click="onSelectTab(tab)"
            ...
            <div class="table-container">
                <table>
                    <thead>
                        <tr>
                            <th class="sticky"></th> <!-- Empty corner cell -->
                    ...
                    <tbody class="body">
                        <tr v-for="(row, rowIndex) in grid.rows" :key="row">
                            ...
                            <td v-for="(cell, colIndex) in gridData[rowIndex]" :key="colIndex"
                                :class="[{ 'text-cell': cell }, { 'active': rowIndex == currentActiveChar.r && colIndex == currentActiveChar.c }]"
...
export default {
    setup() {
        ...
        const audioSrc = computed(() => {
            var _i = grid.value.columns[currentActiveChar.value.c] != " "? grid.value.columns[currentActiveChar.value.c]: "";
            const filename = `${_i}${grid.value.rows[currentActiveChar.value.r]}${selectedTab.value["mapping"]}.mp3`;
...
.pinyin {
    ...
    .tab-view {
        ...
        width: 460px; // Set a fixed width for the tab-view
